...
const examples = [
  '本节课课堂节奏松紧适中，教师能结合职业场景设计英语对话练习，互动引导到位，但习题分层不足，基础薄弱学生跟上进度较吃力。',
  '课堂会结合外贸实操讲解专业英语词汇，小组对话活动调动参与积极性，但课件文字偏多，板书设计简单，缺少口语跟读示范，基础差的学生很难跟上课堂节奏。',
  '课堂教学贴合汽修专业英语需求，实训例句实用性强，愿意主动倾听学生提问，但课堂练习形式单一，缺少 AI 跟读训练，课后答疑时间较短。',
  '教师备课充分，课堂多用职场真实对话案例，善于引导学生开口表达，不过课堂互动集中在少数积极学生，对沉默学生关注度不够，课后拓展学习资源较少。'
]
  ...
  <div class="sentiment-page">
    ...
    <div class="page-header">
      ...
      <div class="header-text">
        ...
        <p class="header-note">4474 条人工标注训练数据，关注实训、互动、学困生、课件、课后资源五个维度，同时覆盖十类学生情绪——学的不只是词和标签，是我对教育行业的理解</p>
      </div>
    </div>
