...
# ============================== 管理员接口 ==============================
@router_admin.get("/", summary="管理员-获取所有用户信息", response_model=list[UserResponse])
...
@router_admin.get("/{user_id}", summary="管理员-获取指定用户信息", response_model=UserResponse)
...
@router_admin.put("/{user_id}", summary="管理员-更新指定用户信息", response_model=UserResponse)
